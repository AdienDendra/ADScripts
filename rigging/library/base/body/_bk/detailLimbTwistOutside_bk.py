...
class CreateDetail:
    ...
    # ==============================================================================================================
        ...
        self.sumTopPma = mc.shadingNode('plusMinusAverage', asUtility=1,
        ...
        self.sumEndPma = mc.shadingNode('plusMinusAverage', asUtility=1,
        ...
        endAffMdl = mc.shadingNode('multDoubleLinear', asUtility=1,
    ...
    # ==================================================================================================================
        if detailLimbDeformer:
            ...
            # Set them rotation  according on point parallelFaceAxis position
            # self.twistDef  = self.nonlinearDeformer(objects=[geoPlaneTwist[0]], defType='twist',
            #                                        name=au.prefixName(geoPlaneTwist[0]), lowBound=-1,
            #                                        highBound=1, rotate=rotDefomer[parallelAxis])
        ...
        mc.parent(geoPlaneTwist[0], geoPlaneOrient[0], self.grpSurfaces)
