...
class Nose:
    def __init__(self,
        ...
        left_side = self.nostril_setup(side=side_LFT, attribute_offset=nostril_attr_ctrl_LFT,
                                       ...
                                       controller_corner_lip=lip_corner_ctrl_LFT, controller_upper_lip=up_lip_controller_all,
        ...
        right_side = self.nostril_setup(side=side_RGT, attribute_offset=nostril_attr_ctrl_RGT,
                                       multiplier=-1, nose_follow_mouth_value=nose_follow_mouth_value,
                                       controller_mouth=mouth_ctrl,
                                       controller_corner_lip=lip_corner_ctrl_RGT, controller_upper_lip=up_lip_controller_all,
    ...
    def squash_stretch_jaw_mouth_uplip(self, range_mouth, input_1X_mouth, range_lip, input_1X_lip, input_1X_jaw, range_jaw):
        mouth = self.set_value_weight(name='nostrilWeight', input_2X_set=range_mouth, input_1X=input_1X_mouth,
    ...
    def nostril_setup(self, side, attribute_offset,
                      ...
                      controller_corner_lip, controller_upper_lip, value_translateX, value_translateY, value_translateZ):
    ...
    def mdl_set_attr(self, name, prefix, name_expression, side, input1, input2_set):
        corner_lip_range_mdl = mc.createNode('multDoubleLinear',n=name + prefix + name_expression + 'Ctrl' + side + '_mdl')
        mc.connectAttr(input1, corner_lip_range_mdl + '.input1')
