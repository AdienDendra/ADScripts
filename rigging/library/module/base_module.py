...
class Part:
    ...
    def __init__(self,
        ...
        au.lock_attr(['t', 'r', 's', ], self.top_grp)
        au.lock_attr(['t', 'r', 's', ], self.control_grp)
        au.lock_attr(['t', 'r', 's', ], self.joint_grp)
        au.lock_attr(['t', 'r', 's', ], self.utils_grp)
        au.lock_attr(['t', 'r', 's', ], self.non_transform_grp)
