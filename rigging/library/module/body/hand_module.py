...
class Hand:
    def __init__(self,
        ...
        if parent:
            ...
            if thumb:
                ...
                self.general_adl_thumb1 = mc.createNode('addDoubleLinear',
                                                        n='%s%s%s%s_adl' % ('thumb01', 'General', 'CrunchCurl', side))
                self.general_adl_thumb3 = mc.createNode('addDoubleLinear',
                ...
                # curl general
                self.general_curl_thumb3 = mc.createNode('addDoubleLinear',
            ...
            if index:
                ...
                # connect general slide crunch, and curl
                self.general_adl_index2 = mc.createNode('addDoubleLinear', n='%s%s%s%s_adl' % (
                    'index02', 'General', 'SlideCrunchCurl', side))
                self.general_adl_index3 = mc.createNode('addDoubleLinear', n='%s%s%s%s_adl' % (
                    'index03', 'General', 'SlideCrunchCurl', side))
                self.general_adl_index4 = mc.createNode('addDoubleLinear', n='%s%s%s%s_adl' % (
    ...
    def curl(self, name_connection, control_finger_setup, prefix_finger, side, output):
        ...
        self.finger_add_two_cup = mc.createNode('addDoubleLinear',
    ...
    def cup(self, name_connection, control_finger_setup, prefix_finger, side, percentage, output):
        ...
        self.finger_cup_percentage_mdl = mc.createNode('multDoubleLinear', n='%s%s%s_mdl' % (
    ...
    def spread(self, name_connection, control_finger_setup, prefix_finger, side, percentage, output):
        # multiplied by percentage
        self.finger_spread_percentage_mdl = mc.createNode('multDoubleLinear',
    ...
    def slide(self, control_finger_setup, name_connection, prefix_finger, side, output2, output3, output4):
        # finger up
        self.finger2_slide_adl = mc.createNode('addDoubleLinear', n='%s%s%s%s_adl' % (
        ...
        # finger mid
        self.finger3_slide_mdl = mc.createNode('multDoubleLinear', n='%s%s%s%s_mdl' % (
        ...
        # finger low
        self.finger4_slide_mdl = mc.createNode('multDoubleLinear', n='%s%s%s%s_mdl' % (
    ...
    def crunch(self, control_finger_setup, name_connection, prefix_finger, side, output2, output3, output4):
        ...
        # finger mid
        self.finger3_crunch_mdl = mc.createNode('multDoubleLinear', n='%s%s%s%s_mdl' % (
            prefix_finger, 'Mid', name_connection.capitalize(), side))
