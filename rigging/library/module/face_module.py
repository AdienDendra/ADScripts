...
def build_rig(
    ...
    mc.setAttr(sj.eyeball_RGT + '.rotateY', eye_ctrl_direction * -1)
    ...
    head = hm.Head(face_anim_ctrl_grp=face_controller_grp,
    ...
    #                                                     LIP PARAMETERS
    # ==================================================================================================================
    lip = lm.Lip(face_anim_ctrl_grp=face_controller_grp,
                 face_utils_grp=face_non_transform_grp,
    ...
    leftCheek = cm.Cheek(face_anim_ctrl_grp=face_controller_grp,
                         face_utils_grp=face_non_transform_grp,
