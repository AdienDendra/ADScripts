...
class CreateRibbon:
    def __init__(self,
       ...
       # Create the controllers
        ...
        mc.delete(mc.orientConstraint(base, self.jointUpOrientParent[0], mo=0))
        mc.delete(mc.orientConstraint(tip, self.jointDownOrientParent[0], mo=0))
        mc.delete(mc.orientConstraint(base, tip, self.jointMidOrientParent[0], mo=0))
        # cr.decomposeMatrix(module, self.jointUpOrientParent[0])
        # cr.decomposeMatrix(tip, self.jointDownOrientParent[0])
