...
class DisplayColorOverrideUi:
    ...
    def display():
        ...
        main_window = cmds.window(DisplayColorOverrideUi.WINDOW_NAME, title="Display Color Override", rtf=True,
                                  sizeable=False)
        ...
        cmds.formLayout(main_layout, edit=True,
                        attachControl=(override_button, "top", DisplayColorOverrideUi.FORM_OFFSET,
                                       DisplayColorOverrideUi.color_palette))
        cmds.formLayout(main_layout, edit=True,
