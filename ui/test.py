...
class BSControlsUtils():
    ...
    def bsNameCurve(self, obj, name):
        ...
        suffixList = ['_JNT', '_Jnt', '_jnt', '_Bnd', '_BND', '_bnd', '_JT', '_Jt', '_jt', '_DRV', 'Drv', '_drv',
                      '_CON', '_Con', '_con', '_CTRL', '_Ctrl', 'ctrl'
                                                                '_anim', '_ANIM', '_Anim', '_LOC', '_Loc', '_loc',
                      '_GRP', '_Grp', '_grp']
...
class BSControlsData():
    ...
    controlNames = ['Circle', 'Half Circle', 'Square', 'Triangle', 'Sphere', 'Half Sphere', 'Box', 'Pyramid', 'Diamond',
                    ...
                    'Sphere Pin', 'Circle Dumbbell', 'Square Dumbbell', 'Sphere Dumbbell', 'Cross', 'Cross Thin',
                    'Locator', 'Four Arrows', 'Four Arrows Thin',
                    'Curved Four Arrows', 'Curved Four Arrows Thin', 'Two Arrows', 'Two Arrows Thin',
                    'Curved Two Arrows', 'Curved Two Arrows Thin', 'One Arrow',
                    'One Arrow Thin', 'Circle One Arrow', 'Circle Two Arrows', 'Circle Three Arrows',
                    'Circle Four Arrows', 'Sphere Four Arrows', 'Gear']
